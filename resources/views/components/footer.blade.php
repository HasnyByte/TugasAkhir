<footer class="bg-[#71B53A] text-white px-8 py-12">
        ...
        <div>
            ...
            <ul class="space-y-2">
                <li>
                    ...
                    <a href="mailto:grocery@gmail.com" class="text-white hover:underline">grocery@gmail.com</a>
                </li>
                <li>
                    <span class="font-normal">Telepon:</span>
                    <a href="tel:+62823467890562" class="text-white hover:underline">+62-8234-6789-0562</a>
                </li>
                <li>
    ...
    <div class="text-center mt-12 text-sm text-white/80">
